...
# Generate a random bit stream for Unipolar NRZ
...
plt.title('Unipolar NRZ Frequency Spectrum (Random Data)')
plt.grid(True, alpha=0.3)
plt.xlim(0, 2 / Tb)  # Up to 2 * bit rate
plt.axvline(1/Tb, linestyle='--', color='red', label='Bit Rate')
plt.legend()
plt.tight_layout()
plt.savefig("note_10_spectrum.png", dpi=200)
