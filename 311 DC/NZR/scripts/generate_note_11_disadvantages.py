...
# Polar NRZ-L for disadvantages example: 11110000
bit_stream = [1, 1, 1, 1, 0, 0, 0, 0]
Tb = 1  # bit duration
...
plt.xlabel("Time (T_b)")
plt.ylabel("Voltage")
plt.title("Polar NRZ-L: Bit Stream 11110000 (Long Runs Example)")
...
plt.tight_layout()
plt.savefig("note_11_disadvantages.png", dpi=200)
# plt.show()